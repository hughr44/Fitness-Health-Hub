                      ...
                      {daysPerWeek === 3 ? (
                        <>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            ...
                            <p className="text-gray-700">Full Body A</p>
                          </div>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                          ...
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            ...
                            <p className="text-gray-700">Full Body B</p>
                          </div>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                          ...
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            ...
                            <p className="text-gray-700">Full Body C</p>
                          </div>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                        ...
                        <>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            <p className="font-semibold text-purple-600">Monday</p>
                            <p className="text-gray-700">Upper Body</p>
                          </div>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            <p className="font-semibold text-purple-600">Tuesday</p>
                            <p className="text-gray-700">Lower Body</p>
                          </div>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            <p className="font-semibold text-purple-600">Wednesday</p>
                            <p className="text-gray-700">Rest</p>
                        ...
                        // Default to PPL for other day counts
                        <>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            <p className="font-semibold text-purple-600">Monday</p>
                            <p className="text-gray-700">Push</p>
                          </div>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            <p className="font-semibold text-purple-600">Tuesday</p>
                            <p className="text-gray-700">Pull</p>
                          </div>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            <p className="font-semibold text-purple-600">Wednesday</p>
                            <p className="text-gray-700">Legs</p>
                          </div>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            <p className="font-semibold text-purple-600">Thursday</p>
                            <p className="text-gray-700">{daysPerWeek >= 4 ? 'Push' : 'Rest'}</p>
                          </div>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            <p className="font-semibold text-purple-600">Friday</p>
                            <p className="text-gray-700">{daysPerWeek >= 5 ? 'Pull' : 'Rest'}</p>
                          </div>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            <p className="font-semibold text-purple-600">Saturday</p>
                            <p className="text-gray-700">{daysPerWeek >= 6 ? 'Legs' : 'Rest'}</p>
                          </div>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            <p className="font-semibold text-purple-600">Sunday</p>
                            <p className="text-gray-700">Rest</p>
